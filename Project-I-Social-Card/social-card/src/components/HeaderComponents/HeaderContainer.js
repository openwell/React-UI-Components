...
const headerContainer = () => {
  const data = {
    ...
    content: `Lorem ipsum dolor sit amet consectetur adipisicing elit. 
      Maiores facere maxime harum. Sint dicta, adipisci repudiandae vero 
      nihil itaque? Autem aperiam dolore perspiciatis atque libero?`,
  ...
  return (
    <div className="HeaderContainer">
      ...
      <div className="HeaderContainer_Sub">
        <HeaderTitle title={data.title} time={data.time}/>
